...
void cv_utf16le_encoder_init( cv_unicode_encoder * p_this ) {
    cv_unicode_encoder_init(p_this, cv_unicode_format_utf16le);
}
...
void cv_utf16le_encoder_cleanup( cv_unicode_encoder * p_this ) {
...
cv_uptr cv_utf16le_encoder_produce( cv_unicode_encoder * p_this,
    unsigned long i_input) {
    cv_debug_assert_(p_this, cv_debug_code_null_ptr);
    cv_debug_assert_(cv_unicode_format_utf16le == p_this->e_format,
        cv_debug_code_error);
    p_this->i_count = 0;
    ...
    if (i_input < 0x10000ul) {
        ...
        p_this->a_accum[3u] = i_w1l & 0xffu;
        p_this->a_accum[2u] = i_w1h & 0xffu;
        p_this->a_accum[1u] = i_w2l & 0xffu;
        p_this->a_accum[0u] = i_w2h & 0xffu;
        p_this->i_count = 4u;
    }
...
cv_bool cv_utf16le_encoder_consume( cv_unicode_encoder * p_this,
...
/* end-of-file: cv_utf16le_encoder.c */
