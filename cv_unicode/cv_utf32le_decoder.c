...
void cv_utf32le_decoder_init(cv_unicode_decoder * p_this) {
    cv_unicode_decoder_init(p_this, cv_unicode_format_utf32le);
}
...
void cv_utf32le_decoder_cleanup(cv_unicode_decoder * p_this) {
...
cv_bool cv_utf32le_decoder_produce(cv_unicode_decoder * p_this,
    unsigned char c_token) {
    cv_debug_assert_(p_this, cv_debug_code_null_ptr);
    cv_debug_assert_(p_this->i_count <= 4u, cv_debug_code_error);
    cv_debug_assert_(p_this->e_format == cv_unicode_format_utf32le,
        cv_debug_code_error);
...
cv_bool cv_utf32le_decoder_consume(cv_unicode_decoder * p_this,
...
/* end-of-file: cv_utf32le_decoder.c */
