...
#define cv_convert_c2u_(expr) cv_cast_(unsigned char, expr)

#define cv_convert_s2u_(expr) cv_cast_(unsigned short, expr)

#define cv_convert_i2u_(expr) cv_cast_(unsigned int, expr)

#define cv_convert_l2u_(expr) cv_cast_(unsigned long, expr)

#define cv_convert_p2u_(expr) cv_cast_(cv_uptr, expr)

#define cv_convert_ll2u_(expr) cv_cast_(cv_ull, expr)

#define cv_convert_u2c_(expr) cv_cast_(signed char, expr)

#define cv_convert_u2s_(expr) cv_cast_(signed short, expr)

#define cv_convert_u2i_(expr) cv_cast_(signed int, expr)

#define cv_convert_u2l_(expr) cv_cast_(signed long, expr)

#define cv_convert_u2p_(expr) cv_cast_(cv_sptr, expr)

#define cv_convert_u2ll_(expr) cv_cast_(cv_sll, expr)
